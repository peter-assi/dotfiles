...
if !exists("g:no_plugin_maps") && !exists("g:no_cucumber_maps")
  nmap <silent><buffer> <C-s>       :<C-U>exe <SID>jump('edit',v:count)<CR>
  nmap <silent><buffer> <C-W>s      :<C-U>exe <SID>jump('split',v:count)<CR>
  nmap <silent><buffer> <C-W><C-s>  :<C-U>exe <SID>jump('split',v:count)<CR>
  nmap <silent><buffer> <C-W>}      :<C-U>exe <SID>jump('pedit',v:count)<CR>
  let b:undo_ftplugin .= "| sil! nunmap <buffer> <C-s>| sil! nunmap <buffer> <C-W>s| sil! nunmap <buffer> <C-W><C-s>| sil! nunmap <buffer> <C-W>}"
endif
